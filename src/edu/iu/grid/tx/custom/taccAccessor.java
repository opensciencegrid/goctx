...
public class taccAccessor extends RTAccessor {

	public taccAccessor(String baseuri, String user, String password, String default_queue, Boolean basic_auth) throws AxisFault {
		super(baseuri, user, password, default_queue, false);
	...
	public RTTicket get(String id) {
		...
		ticket.setOriginNote("TACC Ticket: Queue=" + ticket.getQueue() + " ID=" + ticket.getTicketID());
		return ticket;
	}
