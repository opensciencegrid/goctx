...
wsdl2java.sh -S ../src -ssi -or -uri /tmp/remedy.wsdl -p edu.iu.grid.tx.soap.remedy 

wget --no-check-certificate -O /tmp/remedy.create.wsdl $url/HPD_IncidentInterface_Create_WS
wsdl2java.sh -S ../src -ssi -or -uri /tmp/remedy.create.wsdl -p edu.iu.grid.tx.soap.remedy 
